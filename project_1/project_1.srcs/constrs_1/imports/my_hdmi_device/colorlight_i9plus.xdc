...
set_property IOSTANDARD TMDS_33 [get_ports {DVI0_p[0]}]
set_property PULLTYPE PULLUP [get_ports {DVI0_p[0]}]
set_property PACKAGE_PIN N13 [get_ports {DVI0_p[0]}]
set_property PACKAGE_PIN N14 [get_ports {DVI0_n[0]}]
set_property IOSTANDARD TMDS_33 [get_ports {DVI0_n[0]}]
set_property PULLTYPE PULLUP [get_ports {DVI0_n[0]}]

set_property IOSTANDARD TMDS_33 [get_ports {DVI0_p[1]}]
set_property PULLTYPE PULLUP [get_ports {DVI0_p[1]}]
set_property PACKAGE_PIN R18 [get_ports {DVI0_p[1]}]
set_property PACKAGE_PIN T18 [get_ports {DVI0_n[1]}]
set_property IOSTANDARD TMDS_33 [get_ports {DVI0_n[1]}]
set_property PULLTYPE PULLUP [get_ports {DVI0_n[1]}]

set_property IOSTANDARD TMDS_33 [get_ports {DVI0_p[2]}]
set_property PULLTYPE PULLUP [get_ports {DVI0_p[2]}]
set_property PACKAGE_PIN P16 [get_ports {DVI0_p[2]}]
set_property PACKAGE_PIN R17 [get_ports {DVI0_n[2]}]
set_property IOSTANDARD TMDS_33 [get_ports {DVI0_n[2]}]
set_property PULLTYPE PULLUP [get_ports {DVI0_n[2]}]

set_property PACKAGE_PIN N18 [get_ports TMDS_Clk_p]
set_property IOSTANDARD TMDS_33 [get_ports TMDS_Clk_p]
set_property PULLTYPE PULLUP [get_ports TMDS_Clk_p]
set_property PACKAGE_PIN N19 [get_ports TMDS_Clk_n]
set_property IOSTANDARD TMDS_33 [get_ports TMDS_Clk_n]
set_property PULLTYPE PULLUP [get_ports TMDS_Clk_n]

set_property PACKAGE_PIN R19 [get_ports {P4sw[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {P4sw[0]}]
set_property PULLTYPE PULLUP [get_ports {P4sw[0]}]
set_property PACKAGE_PIN AB21 [get_ports {P4sw[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {P4sw[1]}]
set_property PULLTYPE PULLUP [get_ports {P4sw[1]}]
...
################################################################################
set_property CLOCK_DEDICATED_ROUTE BACKBONE [get_nets dvi_in/U0/TMDS_ClockingX/CLK_IN_hdmi_clk]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets dvi_in/U0/TMDS_ClockingX/CLK_OUT_5x_hdmi_clk]
# set_property CLOCK_REGION X0Y2 [get_cells {dvi_in/U0/TMDS_ClockingX/SerialClkBuffer}]
